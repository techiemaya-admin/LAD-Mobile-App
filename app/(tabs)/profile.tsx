    ...
    <AnimatedScreen style={[styles.container, { backgroundColor: appTheme.background }]}>
      ...
      >
        <GlassCard style={styles.profileCard}>
          ...
          <View style={[styles.planBadge, { backgroundColor: appTheme.darkMode ? appTheme.labelBackground : Theme.colors.infoLight, borderColor: appTheme.darkMode ? appTheme.labelBorder : 'transparent', borderWidth: appTheme.darkMode ? 1 : 0 }]}>
