...
function useProfilePalette() {
  ...
  return useMemo(() => ({
    ...
    surfaceElevated: appTheme.darkMode ? '#071131' : '#FFFFFF',
    ...
    pillBg: appTheme.darkMode ? appTheme.labelBackground : '#F8FAFC',
    ...
    graphCanvas: appTheme.darkMode ? '#0A1957' : '#FFFFFF',
...
function StatusPill({ label, color }: { label: string; color: string }) {
  const palette = useProfilePalette();
  return (
    <View style={[styles.statusPill, { backgroundColor: palette.darkMode ? palette.badgeBg : `${color}1a`, borderColor: palette.darkMode ? `${color}55` : 'transparent', borderWidth: palette.darkMode ? 1 : 0 }]}>
