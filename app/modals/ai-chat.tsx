  ...
  return (
    ...
    >
      ...
      <View style={styles.inputArea}>
            ...
            return (
              <TouchableOpacity
                ...
                style={[styles.actionChip, {
                  backgroundColor: appTheme.darkMode ? appTheme.labelBackground : Theme.colors.infoLight,
                  borderColor: appTheme.darkMode ? appTheme.labelBorder : Theme.colors.info,
                }]}
        ...
        <GlassCard style={[styles.inputCard, { backgroundColor: appTheme.input }]}>
          <TextInput
            style={styles.input}
