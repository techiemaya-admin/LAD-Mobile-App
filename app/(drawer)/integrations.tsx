                ...
                <GlassCard style={styles.card}>
                  ...
                  <View style={styles.cardBody}>
                    ...
                    {isConnected && (item.accountName || item.email) && (
                      <View style={[styles.accountBadgeContainer, { backgroundColor: appTheme.darkMode ? appTheme.labelBackground : appTheme.softSurface, borderColor: appTheme.darkMode ? appTheme.labelBorder : appTheme.border }]}>
