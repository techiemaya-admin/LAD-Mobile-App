                      ...
                      {visiblePermissions.length ? (
                        <View style={styles.permissionPills}>
                          {visiblePermissions.map((permission) => (
                            <View key={`${member.id}-${permission}`} style={[styles.permissionChip, { backgroundColor: appTheme.darkMode ? appTheme.labelBackground : appTheme.primarySoft }]}>
                          ...
                          {hiddenPermissionCount ? (
                            <View style={[styles.permissionChip, { backgroundColor: appTheme.darkMode ? appTheme.labelBackground : appTheme.softSurface, borderColor: appTheme.darkMode ? appTheme.labelBorder : appTheme.border }]}>
