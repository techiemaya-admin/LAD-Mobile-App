          ...
          <View key={s.key}>
            {i > 0 && (
              <View style={styles.convRow}>
                <View style={[styles.convPill, { backgroundColor: appTheme.darkMode ? appTheme.labelBackground : appTheme.softSurface }]}>
            ...
            return (
              <TouchableOpacity
                ...
                style={[
                  ...
                  appTheme.darkMode
                    ? {
                        backgroundColor: isActive ? appTheme.labelBackgroundActive : appTheme.labelBackground,
                        borderColor: appTheme.labelBorder,
                      }
                    : isActive
              ...
              >
                <Typography
                  variant="caption"
                  color={appTheme.darkMode ? (isActive ? appTheme.primaryAccent : appTheme.labelText) : isActive ? Theme.colors.surface : appTheme.muted}
