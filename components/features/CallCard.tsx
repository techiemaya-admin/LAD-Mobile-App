...
export const CallCard: React.FC<CallCardProps> = memo(({ call, onPress }) => {
  ...
  const statusChipBackground = appTheme.darkMode ? appTheme.labelBackground : statusMeta.backgroundColor;
  const statusChipBorder = appTheme.darkMode ? `${statusMeta.color}66` : statusMeta.borderColor;
    ...
    <GlassCard style={styles.container}>
      <TouchableOpacity onPress={onPress} activeOpacity={0.7} style={styles.touchTarget}>
        <View style={styles.avatarContainer}>
          ...
          {call.statusColor && (
            <View style={[styles.statusDot, { backgroundColor: call.statusColor, borderColor: appTheme.surface }]} />
          )}
        </View>
              ...
              style={[
                styles.statusBadge,
                {
                  backgroundColor: appTheme.darkMode
                    ...
                    : statusMeta.isLive ? `${statusMeta.color}14` : statusMeta.backgroundColor,
                  borderColor: appTheme.darkMode
                    ? statusChipBorder
                    : statusMeta.isLive ? `${statusMeta.color}30` : statusMeta.borderColor,
                },
              ]}
            >
              {statusMeta.isLive ? (
